...
| Change Discord HTTP behavior | `undiscord_cli/client.py` | Retry, headers, rate-limit parsing, API paths |
| Adjust config loading rules | `undiscord_cli/config.py` | Precedence + env parsing logic |
